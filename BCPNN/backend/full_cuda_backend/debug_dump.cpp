/*
  ...
  CUDA_CALL(cudaMemcpy(h_Ci, Ci, n_hidden * sizeof(float), cudaMemcpyDeviceToHost));
  CUDA_CALL(cudaMemcpy(h_Cj, Cj, n_outputs * sizeof(float), cudaMemcpyDeviceToHost));
  CUDA_CALL(cudaMemcpy(h_Cij, Cij, n_hidden * n_outputs * sizeof(float), cudaMemcpyDeviceToHost));
