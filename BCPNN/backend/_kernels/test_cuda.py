...
def test_update_counters(k1, k2):
    ...
    Ci1, Cj1, Cij1 = k1.update_counters(
        Ci1, Cj1, Cij1, inputs, outputs, taupdt)
...
def test_update_weights(k1, k2):
    ...
    weights1 = k1.update_weights(weights1, Ci, Cj, Cij, taupdt)
    weights2 = k2.update_weights(weights2, Ci, Cj, Cij, taupdt)
