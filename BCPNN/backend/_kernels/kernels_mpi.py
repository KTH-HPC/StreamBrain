...
import _bcpnn_kernels_mpi_internal as _i
...
def update_weights(Ci, Cj, Cij, a_i, a_o, taupdt, weights, cthr):
    if Ci.dtype == np.float64:
        _i.update_weights_float64(1.0, Ci, Cj, Cij, a_i, a_o, taupdt, weights, cthr)
    elif Ci.dtype == np.float32:
        _i.update_weights_float32(1.0, Ci, Cj, Cij, a_i, a_o, taupdt, weights, cthr)
    else:
        raise Exception("Invalid dtype")
