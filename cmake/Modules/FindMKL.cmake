# From https://github.com/marian-nmt/marian-dev/blob/master/cmake/FindMKL.cmake
################################################################################
#
...
if (MKL_INCLUDE_DIRS AND MKL_LIBRARIES AND MKL_INTERFACE_LIBRARY AND
    MKL_THREADING_LAYER_LIBRARY AND MKL_CORE_LIBRARY)
...
set(MKL_LIBRARIES -Wl,--start-group ${MKL_INTERFACE_LIBRARY} ${MKL_THREADING_LAYER_LIBRARY} ${MKL_CORE_LIBRARY} -Wl,--end-group)

# message("1 ${MKL_INCLUDE_DIR}")
# message("2 ${MKL_INTERFACE_LIBRARY}")
# message("3 ${MKL_SEQUENTIAL_LAYER_LIBRARY}")
# message("3 ${MKL_THREADING_LAYER_LIBRARY}")
# message("4 ${MKL_CORE_LIBRARY}")

if (MKL_INCLUDE_DIR AND
    MKL_INTERFACE_LIBRARY AND
    MKL_THREADING_LAYER_LIBRARY AND
    MKL_CORE_LIBRARY)
  ...
  set(MKL_THREADING_LAYER_LIBRARY "")
